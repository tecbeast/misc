...
/*
 * $Id: Piccolo.java,v 1.1 2004/04/25 20:12:38 Georg Exp $
 *
...
public EntityResolver getEntityResolver() {
  return lexer.entityManager.getResolver();
}
...
public boolean getFeature(String name) throws SAXNotSupportedException, SAXNotRecognizedException {
  if (name.equals("http://xml.org/sax/features/namespaces"))
    ...
    name.equals("http://xml.org/sax/features/use-attributes2")
...
private void saveAttributeDefinition(String prefix, String localName, String qName, int valueType, int defaultType, String defaultValue)
  ...
  try {
    ...
    if (declHandler != null) {
      ...
      } else if (valueType == AttributeDefinition.ENUMERATION) {
      ...
      declHandler.attributeDecl(elementDefinition.getName(), qName, valueTypeString, AttributeDefinition.getDefaultTypeString(defaultType), defaultValue);

      modelBuffer.setLength(0);
    }

    elementDefinition.addAttribute(new AttributeDefinition(prefix, localName, qName, valueType, null, defaultType, defaultValue));
    ...
    switch (yyn) {
      ...
      case 25 :
        //#line 136 "Piccolo.y"
        {
          ...
          lexer.yybegin(PiccoloLexer.DTD);
        }
        break;
      case 26 :
        //#line 142 "Piccolo.y"
      ...
      case 48 :
        //#line 215 "Piccolo.y"
        {
          lexer.yybegin(PiccoloLexer.DTD_IGNORE);
        }
        break;
      case 52 :
        //#line 228 "Piccolo.y"
      ...
      case 53 :
        //#line 233 "Piccolo.y"
        {
          try {
            ...
            reportFatalError("Invalid system identifier: " + sysID + "; " + e.getMessage());
          }
        }
        break;
      case 54 :
      ...
      case 64 :
        //#line 313 "Piccolo.y"
        {
          lexer.yybegin(PiccoloLexer.DTD_ATT_NAME);
