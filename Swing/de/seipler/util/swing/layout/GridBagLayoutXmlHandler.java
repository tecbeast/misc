...
public class GridBagLayoutXmlHandler extends DefaultHandler {
  ...
  public static final String TAG_CONSTRAINTS_DEFAULT = "constraints-default";  
  ...
  public void startElement(String uri, String localName, String qName, Attributes attributes) throws SAXException {
    if (TAG_CONSTRAINTS.equals(qName)) {
      constraintsId = attributes.getValue(ATTRIBUTE_ID);
      resetConstraints();
    } else if (TAG_CONSTRAINTS_DEFAULT.equals(qName)) {
      defaultContext = true;
  ...
  public void endElement(String uri, String localName, String qName) throws SAXException {
    ...
    } else if (TAG_CONSTRAINTS.equals(qName)) {
