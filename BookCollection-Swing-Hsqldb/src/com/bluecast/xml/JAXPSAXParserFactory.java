/*
 * $Id: JAXPSAXParserFactory.java,v 1.1 2004/04/25 20:12:38 Georg Exp $
 *
...
public class JAXPSAXParserFactory extends SAXParserFactory {
  ...
  */
  ...
  private ParserConfigurationException pendingValidatingException = null, pendingNonvalidatingException = null;
  ...
  public JAXPSAXParserFactory() {
    ...
    try {
      if (validatingFactoryClass != null) {
        validatingFactory = (SAXParserFactory) validatingFactoryClass.newInstance();
  ...
  public SAXParser newSAXParser() throws ParserConfigurationException, SAXException {
    if (validating) {
      ...
      else if (pendingValidatingException != null)
  ...
  public void setFeature(String name, boolean enabled) throws ParserConfigurationException, SAXNotRecognizedException, SAXNotSupportedException {
    ...
    if (validating && pendingValidatingException != null)
      throw pendingValidatingException;
    else if (!validating && pendingNonvalidatingException != null)
      throw pendingNonvalidatingException;
  }
  ...
  public void setNamespaceAware(boolean awareness) {
    ...
    try {
      nvParser.setFeature("http://xml.org/sax/features/namespaces", awareness);
      nvParser.setFeature("http://xml.org/sax/features/namespace-prefixes", !awareness);
    } catch (SAXNotSupportedException e) {
      pendingNonvalidatingException = new ParserConfigurationException("Error setting namespace feature: " + e.toString());
  ...
  private static Class findValidatingFactory() {
    ...
    try {
      Enumeration enum = FactoryServiceFinder.findServices("javax.xml.parsers.SAXParserFactory");
  ...
  */
  ...
  private void reconfigureValidating() {
    ...
    try {
      ...
      while (iter.hasNext()) {
        ...
        validatingFactory.setFeature((String) entry.getKey(), ((Boolean) entry.getValue()).booleanValue());
      }
    } catch (ParserConfigurationException e) {
      pendingValidatingException = e;
    } catch (SAXNotRecognizedException e) {
      pendingValidatingException = new ParserConfigurationException(e.toString());
    } catch (SAXNotSupportedException e) {
      pendingValidatingException = new ParserConfigurationException(e.toString());
    }
  }
  ...
  private void reconfigureNonvalidating() {
    try {
      ...
      while (iter.hasNext()) {
        Map.Entry entry = (Map.Entry) iter.next();
        nvParser.setFeature((String) entry.getKey(), ((Boolean) entry.getValue()).booleanValue());
      }
    } catch (SAXNotRecognizedException e) {
      pendingNonvalidatingException = new ParserConfigurationException(e.toString());
    } catch (SAXNotSupportedException e) {
      pendingNonvalidatingException = new ParserConfigurationException(e.toString());
    }
  }
