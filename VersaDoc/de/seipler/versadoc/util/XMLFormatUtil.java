package de.seipler.versadoc.util;
...
public class XMLFormatUtil {
   ...
   * 
   */
  public static void writeXMLHeaderTo(OutputStream out) throws IOException{
    StringBuffer buffer = new StringBuffer(40);    
    buffer.append("<?xml version=\"1.0\" encoding=\"");
    buffer.append(encoding);
    buffer.append("\"?>");
    buffer.append(lineSeparator);
    out.write(encode(buffer.toString()));
  }

  /**
   * 
   */
  public static void writeElementTo(OutputStream out, int indentation, String name, int value) throws IOException {
    if (value < 0) {
   ...
   * 
   */
  public static void writeElementTo(OutputStream out, int indentation, String name, String value) throws IOException {
   ...
   * 
   */
  public static void writeElementHeaderTo(OutputStream out, int indentation, String name) throws IOException {
   ...
   * 
   */
  public static void writeElementHeaderTo(OutputStream out, int indentation, String name, String attribute, String value) throws IOException {
    StringBuffer buffer = new StringBuffer(80);
    indent(buffer, indentation);
    buffer.append('<');
    buffer.append(name);
   ...
   * 
   */
  public static void writeElementFooterTo(OutputStream out, int indentation, String name) throws IOException {
    StringBuffer buffer = new StringBuffer(80);
    indent(buffer, indentation);
    buffer.append("</");
    buffer.append(name);
